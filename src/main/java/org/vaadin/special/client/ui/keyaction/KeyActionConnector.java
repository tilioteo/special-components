package org.vaadin.special.client.ui.keyaction;
...
@Connect(org.vaadin.special.ui.KeyAction.class)
	...
	protected void triggerEvent(final KeyDownEvent event) {
		...
		Scheduler.get().scheduleDeferred(new ScheduledCommand() {
			...
			public void execute() {
				...
				getRpcProxy(KeyActionServerRpc.class).trigger(DateUtility.getTimestamp());
			}
		});
	}
